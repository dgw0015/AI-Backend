...
# given a character/integer it returns corresponding integer/character
...
# to represent our sequences as boolean values, we declare zero matrices
...
# fitting our model
model.fit(x, y, BATCH_SIZE, EPOCH, callbacks=callbacks)
...
print(myGenerate(500, 1.0))  # Generates text with given #of characters and text
